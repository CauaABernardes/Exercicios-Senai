...
while num_inscricao != 9999:
    ...
    if total_pontos > maior_pontuacao:
        ...
        num_vencedor = num_inscricao
        empate = False
    elif total_pontos == maior_pontuacao:
        empate = True
...
print("\nResultado Final!!!\n")
if empate:
    print(f"Houve um empate com a pontuação de: {maior_pontuacao} pontos")
else:
    print(f"A equipe ganhadora foi a {num_vencedor}, com {maior_pontuacao} pontos")